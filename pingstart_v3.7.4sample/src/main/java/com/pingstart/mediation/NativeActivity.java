...
public class NativeActivity extends Activity {
    ...
    private com.pingstart.adsdk.view.MediaView mPsMediaView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPsMediaView = (com.pingstart.adsdk.view.MediaView) findViewById(R.id.ad_media_view);
    ...
    private void loadNativeAd() {
        mPingStartNative = new PingStartNative(NativeActivity.this, "1000223");
        //true/false :if support video
        mPingStartNative.setSupportVideo(true);
        mPingStartNative.setAdListener(new NativeListener() {
            @Override
                ...
                if (ad != null) {
                    ...
                    if (workName != null && workName.equalsIgnoreCase("facebook")) {
                        try {
                            ...
                            mPingStartNative.registerNativeView(mFbNative);
                        } catch (Exception e) {
                        }
                        ...
                        mPingStartNative.registerNativeView(mActionButton);
                    }
                }
            }
        ...
        mPingStartNative.loadAd();
    }

    @Override
    protected void onDestroy() {
        super.onDestroy();
        if (mPingStartNative != null) {
            mPingStartNative.destroy();
            mPingStartNative = null;
        }
    }
    ...
    private void populateContentAdView(NativeContentAd nativeContentAd,
        ...
        mPingStartNative.registerNativeView(adView.getCallToActionView());
